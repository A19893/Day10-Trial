  ...
  return (
    ...
    >
      ...
      <div id="template2">
        ...
        <p>{props.data?.email1}</p>
        <p>
          Phone:+{props.data?.prefix1} {props.data?.phone1}
        </p>
        </div>
        </div>
        ...
        <ul>
          ...
          <li style={{color:"black"}}>Angular</li>
          <li style={{color:"black"}}>DSA</li>
        </ul>
        <h1>Education</h1>
        <p>
          {props.data?.university1} Cgpa-{props.data?.cgpa1}
        </p>
        <p>
          {props.data?.school1} {props.data?.schoolMarks1}
        </p>
        <h1>Projects</h1>
        <p>{props.data?.project11}</p>
        <p>{props.data?.project21}</p>
        <h1>Website</h1>
        <p>{props.data?.website1}.com</p>
        </div>
      </div>
      {props.view ? (
